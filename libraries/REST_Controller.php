...
abstract class REST_Controller extends CI_Controller
{
    ...
    {
        if (config_item('rest_use_mongodb')) {
            $status = $this->mongo_db->insert(config_item('rest_logs_collection'), array(
            ...
            $this->_insert_id = $this->mongo_db->insert_id();
        } else {
